                              ...
                              <li id="option-1">
                                    <div class="row mb-4">
                                          ...
                                          <div class="col-md-11">
                                                ...
                                                <input required type="text" placeholder="*Obrigatório*" name="option[1]" class="form-control option">
                                          </div>
                                          <div class="col-md-1">
                                          </div>
                                    </div>
                              ...
                              <li id="option-2">
                                    <div class="row mb-4">
                                          ...
                                          <div class="col-md-11">
                                                ...
                                                <input required type="text" placeholder="*Obrigatório*" name="option[2]" class="form-control option">
                                          </div>
                                          <div class="col-md-1">
                                          </div>
                                    </div>
                              ...
                              <li id="option-3">
                                    <div class="row mb-4">
                                          ...
                                          <div class="col-md-11">
                                                ...
                                                <input required type="text" placeholder="*Obrigatório*" name="option[3]" class="form-control option">
                                          </div>
                                          <div class="col-md-1">
                                          </div>
                                    </div>
